...
def play_audio(filename):
    ...
    play(audio)
def initialize_call(number):
    # Define your Twilio credentials
    account_sid = 'AC65ed2863b160aecee1c8e0b62361abf6'
    auth_token = '5c589989161f31a1f26ac51d3ced8680'
    ...
    while True:
        ...
        if call.status == 'in-progress':
            break
        time.sleep(1) # Sleep for a bit to avoid hammering the API
def main():
    number = "+17573925302"
    initialize_call(number)
    counter = 0
