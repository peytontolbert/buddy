...
class LLMJsonOutputParser(BaseModel):
    ...
    @classmethod
    def parse_and_validate(cls, json_str: str, json_schema: str) -> Union[str, Dict[Any, Any]]:
        """
    ...
    @classmethod
    def _validate_json(cls, json_obj: Union[str, Dict[Any, Any]], json_schema: str) -> Union[str, Dict[Any, Any]]:
        """
